                ...
                <div class="primary">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            <input type="text" value="<?= Yii::t('app', 'Sender') ?>" readonly style="text-align: center; background: #DDDDDD;">
                        </div>
                        <div class="col-md-6 col-lg-6">
                            <input type="text" value="<?= Yii::t('app', 'Receiver') ?>" readonly style="text-align: center; background: #DDDDDD;">
                        </div>
                    </div>
